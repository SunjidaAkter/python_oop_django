    ...
    <div>
      ...
      >
        <div className="lg:w-[70%] w-full py-20 lg:pl-28 pl-4">
          ...
          <Fade cascade duration={2000} direction="up" delay={500}>
          ...
          <Fade cascade duration={2000} direction="up" delay={700}>
            <p className="text-white text-[17px] pb-4">
          ...
          <Fade cascade duration={2000} direction="up" delay={900}>
            <img
              src="https://yummi-theme.myshopify.com/cdn/shop/files/signature.png?v=1614334584&width=200"
              alt=""
            />
          </Fade>
          <Fade cascade duration={2000} direction="up" delay={1100}>
