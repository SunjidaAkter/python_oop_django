...
const Countdown = () => {
  return (
    <div className="flex w-full py-28 px-24 justify-between flex-wrap">
      <div className="lg:w-1/4 md:w-1/2 w-full py-5 md:py-0 lg:py-0 flex flex-col justify-center items-center">
        <img
          ...
          alt=""
        />
        <p className="text-[#3A3A3A] font-bold mt-3 text-[25px]">Menu Types</p>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full py-5 md:py-0 lg:py-0 flex flex-col justify-center items-center">
        <img
          ...
          alt=""
        />
        <p className="text-[#3A3A3A] font-bold mt-3 text-[25px]">Noodles</p>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full py-5 md:py-0 lg:py-0 flex flex-col justify-center items-center">
        <img
          ...
          alt=""
        />
        <p className="text-[#3A3A3A] font-bold mt-3 text-[25px]">
          Different Origin
        </p>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full py-5 md:py-0 lg:py-0 flex flex-col jbold-center items-center">
        <img
          ...
          alt=""
        />
        <p className="text-[#3A3A3A] font-bold mt-3 text-[25px]">Menu To Go</p>
