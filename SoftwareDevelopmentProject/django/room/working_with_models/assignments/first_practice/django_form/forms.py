...
class Form(forms.Form):
    ...
    comment=forms.CharField(label="Comment : ", help_text="Enter your comment",required=True,disabled=False,widget=forms.Textarea (attrs={'rows':3,'placeholder':'Enter your full comment'}))
